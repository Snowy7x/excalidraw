...
import { AppClassProperties, AppProps, AppState, ExcalidrawImperativeAPI, BinaryFiles, LibraryItems, SceneData, Device, FrameNameBoundsCache, SidebarName, SidebarTabName, ScrollConstraints, ToolType, OnUserFollowedPayload } from "../types";
...
declare class App extends React.Component<AppProps, AppState> {
     ...
     */
    setScrollConstraints: (scrollConstraints: ScrollConstraints | null) => void;
}
declare global {
    interface Window {
        h: {
