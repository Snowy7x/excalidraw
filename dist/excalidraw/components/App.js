...
import { calculateConstrainedScrollCenter, constrainScrollState, } from "../scene/scrollConstraints";
...
let scrollConstraintsAnimationTimeout = null;
/**
...
class App extends React.Component {
    ...
    constructor(props) {
        ...
        const { excalidrawAPI, viewModeEnabled = false, zenModeEnabled = false, gridModeEnabled = false, objectsSnapModeEnabled = false, theme = defaultAppState.theme, name = defaultAppState.name, scrollConstraints, } = props;
        this.state = {
            ...defaultAppState,
            theme,
            isLoading: true,
        ...
        return (_jsx("div", { className: clsx("excalidraw excalidraw-container", {
                ...
                ["--ui-pointerEvents"]: shouldBlockPointerEvents
                    ...
                    : POINTER_EVENTS.enabled,
                                                        ...
                                                        this.state.showHyperlinkPopup && (_jsx(Hyperlink, { element: firstSelectedElement, setAppState: this.setAppState, onLinkOpen: this.props.onLinkOpen, setToast: this.setToast, updateEmbedValidationStatus: this.updateEmbedValidationStatus }, firstSelectedElement.id)), this.props.aiEnabled !== false &&
    ...
    animateTranslateCanvas = ({ fromValues, toValues, duration, onStart, onEnd, onCancel, }) => {
